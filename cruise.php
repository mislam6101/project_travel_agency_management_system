...
<head>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="submenu dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="cruise-detail.html">Car Detail</a></li>
                                            </ul>
                                        </li>
                                        <li class="submenu dropdown">
                ...
                <div class="col-lg-8">
                    <div class="list-results d-flex align-items-center justify-content-between">
                        ...
                        <div class="click-menu d-flex align-items-center justify-content-between">
                            <div class="change-list f-active me-2"><a href="cruise-list.html"><i class="fa fa-bars rounded"></i></a></div>
                            <div class="change-grid me-2"><a href="cruise-grid.html"><i class="fa fa-th rounded"></i></a></div>
                    ...
                    <div class="cruise-list">
                        <div class="cruise-full">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                       <div class="trend-item2 rounded">
                                            <a href="cruise-detail.html" style="background-image: url(images/cruise/1.jpg);"></a>
                                             <div class="color-overlay"></div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="trend-content">
                                            <p class="mb-0">Norwegian Getawayy</p>
                                            <h3 class="mb-2 border-b pb-2"><a href="cruise-detail.html" class="">7 Night Cruise To The eastern Mediterranean</a></h3>
                                            <ul class="featured-meta border-b pb-2 mb-2 d-flex align-items-center justify-content-between">
                                                <li><strong class="d-block"> Sailing Date</strong> 18/06/2022</li>
                                                <li><strong class="d-block"> Departure</strong> Norwich</li>
                                            </ul>
            
                                            <div class="entry-author d-flex align-items-center justify-content-between">
                                                <p class="mb-0"><i class="fa fa-star theme1"></i> 4.82 <small>(94 reviews)</small></p>
                                                <p class="mb-0">From<span class="theme fw-bold fs-5"> $280.00</span</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="trend-full bg-white rounded box-shadow overflow-hidden p-4 mb-4">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                       <div class="trend-item2 rounded">
                                            <a href="cruise-detail.html" style="background-image: url(images/cruise/2.jpg);"></a>
                                             <div class="color-overlay"></div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="trend-content">
                                            <p class="mb-0">British Getawayy</p>
                                            <h3 class="mb-2 border-b pb-2"><a href="cruise-detail.html" class="">5 Night Cruise To The Western Europe</a></h3>
                                            <ul class="featured-meta border-b pb-2 mb-2 d-flex align-items-center justify-content-between">
                                                <li><strong class="d-block"> Sailing Date</strong> 18/06/2022</li>
                                                <li><strong class="d-block"> Departure</strong> Norwich</li>
                                            </ul>
                            ...
                            <div class="trend-full bg-white rounded box-shadow overflow-hidden p-4 mb-4">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                       <div class="trend-item2 rounded">
                                            <a href="cruise-detail.html" style="background-image: url(images/cruise/3.jpg);"></a>
                                             <div class="color-overlay"></div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="trend-content">
                                            <p class="mb-0">British Getawayy</p>
                                            <h3 class="mb-2 border-b pb-2"><a href="cruise-detail.html" class="">10 Night Cruise To The Baltic Sea Area</a></h3>
                                            <ul class="featured-meta border-b pb-2 mb-2 d-flex align-items-center justify-content-between">
                                                <li><strong class="d-block"> Sailing Date</strong> 18/06/2022</li>
                                                <li><strong class="d-block"> Departure</strong> Norwich</li>
                                            </ul>
                            ...
                            <div class="trend-full bg-white rounded box-shadow overflow-hidden p-4 mb-4">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                       <div class="trend-item2 rounded">
                                            <a href="cruise-detail.html" style="background-image: url(images/cruise/4.jpg);"></a>
                                             <div class="color-overlay"></div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                            ...
                            <div class="trend-full bg-white rounded box-shadow overflow-hidden p-4 mb-4">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                       <div class="trend-item2 rounded">
                                            <a href="cruise-detail.html" style="background-image: url(images/cruise/5.jpg);"></a>
                                             <div class="color-overlay"></div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="trend-content">
                                            <p class="mb-0">Italian Getawayy</p>
                                            <h3 class="mb-2 border-b pb-2"><a href="cruise-detail.html" class="">10 Night Cruise To The Baltic Sea Area</a></h3>
                                            <ul class="featured-meta border-b pb-2 mb-2 d-flex align-items-center justify-content-between">
                                                <li><strong class="d-block"> Sailing Date</strong> 18/06/2022</li>
                                                <li><strong class="d-block"> Departure</strong> Norwich</li>
                            ...
                            <div class="trend-full bg-white rounded box-shadow overflow-hidden p-4 mb-4">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                       <div class="trend-item2 rounded">
                                            <a href="cruise-detail.html" style="background-image: url(images/cruise/6.jpg);"></a>
                                             <div class="color-overlay"></div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="trend-content">
                                            <p class="mb-0">British Getawayy</p>
                                            <h3 class="mb-2 border-b pb-2"><a href="cruise-detail.html" class="">12 Night Cruise To The British Island</a></h3>
                                            <ul class="featured-meta border-b pb-2 mb-2 d-flex align-items-center justify-content-between">
                                                <li><strong class="d-block"> Sailing Date</strong> 18/06/2022</li>
                                                <li><strong class="d-block"> Departure</strong> Norwich</li>
                                            </ul>
                        ...
                        <div class="car-btn text-center"><a href="car-list.html" class="nir-btn">Load More</a></div>
                    </div>
                </div>
                        ...
                        <div class="list-sidebar">
                            ...
                            <div class="sidebar-item mb-4">
                                ...
                                <ul class="sidebar-category1">
                                    <li><input type="checkbox" checked> Adaptive Cruise Control <span class="float-end">1192</span></li>
                                    <li><input type="checkbox"> Cooled Seats <span class="float-end">2122</span></li>
                                    <li><input type="checkbox"> Keyless Start <span class="float-end">1435</span></li>
                                    <li><input type="checkbox"> avigation System <span class="float-end">2141</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="counter-item p-3 py-4 rounded bg-white">
                                    <h3 class="value mb-0 theme fs-1">1100</h3>
                            ...
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="counter-item p-3 py-4 rounded bg-white">
                                    <h3 class="value mb-0 theme fs-1">950</h3>
                                    <p class="m-0">Happy Passengers</p>
                                </div>    
                            </div>
    
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="counter-item p-3 py-4 rounded bg-white">
                                    <h3 class="value mb-0 theme fs-1">3472</h3>
                                    <p class="m-0">Planned Trips</p>
                                </div>    
                            </div>
    
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="counter-item p-3 py-4 rounded bg-white">
                                    <h3 class="value mb-0 theme fs-1">523</h3>
                                    <p class="m-0">Cruises</p>
                                </div>    
                            </div>
                        </div>
                    </div> 
    ...
    <!-- about-us starts -->
    <section class="about-us pb-0 pt-10" style="background-image:url(images/shape4.png); background-position:center;">
        <div class="container">
            <div class="row align-items-center d-flex">
                <div class="col-lg-6 mb-4">
                    <div class="section-title">
                        <h4 class="mb-1 theme1">Why To Choose Us</h4>
                        <h2 class="mb-4"><span class="theme">Travelin</span> is a World Leading Cruise Booking Platform</h2>
                        <p class="mb-4">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                        ...
                        <a href="cruise-detail.html" class="nir-btn">Learn More</a>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <!-- why us starts -->
