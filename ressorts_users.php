   ...
   <?php include("includes/header.php") ?>
    ...
    <section class="trending pt-6 pb-0 bg-lgrey">
        <div class="container">
            ...
            <div class="row">
                <?php
                $sql = "SELECT * FROM ressorts ORDER BY id DESC";
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="trend-item rounded box-shadow">
                        <div class="trend-image position-relative">
                            <img style="width : 100%; height : 230px" src="admin/<?php echo $row->ressort_photo; ?>" alt="image" class="">
                            <div class="color-overlay"></div>
                        </div>
                        <div class="trend-content p-4 pt-5 position-relative">
                            
                            <h5 class="theme mb-1"><i class="flaticon-location-pin"></i><?php echo $row->place; ?></h5>
                            ...
                            <div class="entry-meta">
                                <div class="entry-author d-flex align-items-center">
                                    <p class="mb-0"><span class="theme fw-bold fs-5"><?php echo $row->price; ?>৳</span> | Per Night</p>
                                </div>
                            </div>
                        </div>
                    </div>
