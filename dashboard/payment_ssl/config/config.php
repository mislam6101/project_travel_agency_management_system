...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/PWAD-68/travel_agency_project/project_travel_agency_management_system/dashboard/payment_ssl'); // replace this value with your project path
}
