...
$sql = "SELECT * FROM air_tick_req WHERE `id` = '$b_id' ORDER BY id DESC";
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Air Ticket</h6>
                        <small class="text-muted">Dhaka to London</small>
                    </div>
                    <span class="text-muted"><strong><?php echo $cost = $row->price; ?> TK</span></strong>
                </li>
                <li class="list-group-item d-flex justify-content-between">
                    <span>Service Charge</span>
                    <strong class="text-muted"><?php echo ($sb = $cost * 5/100); ?> TK</strong>
                </li>
                <?php
                endwhile; 
                $db->close();
                ...
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (BDT)</span>
                    <strong><?php echo ($sb + $cost); ?> TK</strong>
                </li>
            ...
            <form action="checkout_hosted.php" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="customer_email" class="form-control" id="email"
                           placeholder="you@example.com" value="<?php echo $c_email; ?>" required>
                    <div class="invalid-feedback">
