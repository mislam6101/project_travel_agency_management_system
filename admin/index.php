...
<div class="login-box sty1">
  ...
  <div class="login-logo">
    ...
    <form action="" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" name="pass" placeholder="Password">
      </div>
      <div>
        <div class="col-xs-8">
    ...
    <div class="m-t-2">Don't have an account? <a href="admin_register.php" class="text-center">Sign Up</a></div>
  </div>
  <!-- /.login-box-body --> 
</div>
<!-- ./wrapper --> 
