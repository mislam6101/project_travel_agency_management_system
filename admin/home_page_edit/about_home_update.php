...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-two">
      <h1 class="text-white">Top Destination</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">Updates</a></li>
        <li><i class="fa fa-angle-right"></i>Top Destination</li>
      </ol>
    </div>
    <?php
    $sql = "SELECT * FROM about_home";
    $record = $db->query($sql);
    ...
    <div class="content">
      ...
      if (isset($_REQUEST['click'])) {
                  ...
                  $path =  "images/about_home".$name ;
                  move_uploaded_file($tmp_name, $path);
                  $sql = "UPDATE about_home SET country = '$country', city = '$city', photo = '$path'";
                  $record = $db->query($sql);
                  if($db->affected_rows){
      ...
      ?>
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <h2>Update Top Destinations</h2><br>
          <div class="input-group">
            <div class="input-group-addon"><i class="fa fa-podcast"></i></div>
            <input class="form-control" name="title" value="<?php echo $row->title; ?>" id="exampleInputuname" type="text">
          </div>
          <br><br>
          <div class="card-body">
               <textarea id="summernote" name="msg"></textarea>
            </div>
          <br><br>
          <div class="input-group">
            <div class="input-group-addon"><i class="fa fa-podcast"></i></div>
            <input class="form-control" name="experience" <?php echo $row->experience; ?> id="exampleInputuname" type="text">
          </div>
          <br><br>
          </div>
          <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="card">
                <div class="card-body">
                    <h4 class="text-black">Upload First photo</h4>
                    <label for="input-file-now"></label>
                    <input type="file" name="fst_photo" id="input-file-now" class="dropify" />
                </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="card">
                <div class="card-body">
                    <h4 class="text-black">Upload Last photo</h4>
                    <label for="input-file-now"></label>
                    <input type="file" name="lst_photo" id="input-file-now" class="dropify" />
                </div>
                </div>
            </div>
          </div>
          <br>
          <div class="col-lg-6 col-md-6">
            <div class="text-right"><button style="margin-right : 25px; margin-bottom : 20px" class="btn btn-success" name="click" type="submit">Update</button></div>
          </div>
        </form>
    </div>
    <!-- /.content --> 
