...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <?php
    $sql = "SELECT * FROM top_destinations WHERE top_destinations.id = '$id'";
    $record = $db->query($sql);
    ...
    <div class="content">
      ...
      if (isset($_REQUEST['click'])) {
                  ...
                  $path =  "images/top_destination".$name ;
                  move_uploaded_file($tmp_name, $path);
                  $sql = "UPDATE top_destinations SET country = '$country', city = '$city', photo = '$path' WHERE top_destinations.id = '$id'";
                  $record = $db->query($sql);
                  if($db->affected_rows){
      ...
      ?>
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="input-group">
            ...
            <input class="form-control" name="country" value="<?php echo $row->country; ?>" id="exampleInputuname" type="text">
          </div>
          <br><br>
          <div class="input-group">
            <div class="input-group-addon"><i class="fa fa-podcast"></i></div>
            <input class="form-control" name="city" <?php echo $row->city; ?> id="exampleInputuname" type="text">
          </div>
          <br><br>
          </div>
          <div class="col-lg-6 col-md-6">
