...
<div class="login-box sty1">
  ...
  <div class="login-logo">
    <a href="index.html"><img style="width: 100%;" src="dist/img/tod-logo-updated-V2.png" alt=""></a>
  </div>
    <?php
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
        <input type="name" class="form-control sty1" name="name" placeholder="Name">
      </div>
      <div class="form-group has-feedback">
        <input type="email" class="form-control sty1" name="email" placeholder="Email">
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" name="pass" placeholder="Create Password">
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" name="conf_pass" placeholder="Confirm Password">
      </div>
      <div>
        <div class="col-xs-8">
        ...
        <div class="col-xs-4 m-t-1">
          <button type="submit" name="click" class="btn btn-primary btn-block btn-flat">Sign Up</button>
        </div>
        <!-- /.col --> 
      </div>
    </form>
    ...
    <div class="m-t-2">Already have an account? <a href="index.php" class="text-center">Sign In</a></div>
  </div>
  <!-- /.login-box-body --> 
</div>
<!-- ./wrapper --> 
