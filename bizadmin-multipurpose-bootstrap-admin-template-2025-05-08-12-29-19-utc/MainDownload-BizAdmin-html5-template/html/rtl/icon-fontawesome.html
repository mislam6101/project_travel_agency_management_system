    ...
    <div class="sidebar"> 
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-energy"></i> <span>Icons</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li class="active"><a href="icon-fontawesome.html"><i class="fa fa-angle-left"></i> Fontawesome Icons</a></li>
    ...
    <div class="content">
      ...
      <div class="card-body">
        ...
        <div class="row fontawesome-icon-list">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-angle-left"></i> fa-angle-right</div>
