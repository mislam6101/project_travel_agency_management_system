...
<div class="wrapper boxed-wrapper">
    ...
    <div class="sidebar"> 
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-layers"></i> <span>Widgets</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li class="active"><a href="widget-data.html"><i class="fa fa-angle-right"></i> Data Widgets</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-two">
      <h1 class="text-white">Data Widgets</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">Widgets</a></li>
        <li><i class="fa fa-angle-right"></i> Data Widgets</li>
      </ol>
    </div>
          ...
          <div class="widget-info bg-primary">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6 m-t-2 text-right"> <span id="spa-bar"><canvas style="display: inline-block; width: 102px; height: 70px; vertical-align: top;" width="102" height="70"></canvas></span> </div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 text-white">
                  ...
                  <a href="#">View Statement</a> </div>
                <div class="col-md-6 m-t-2 text-right"> <span id="spa-line"><canvas style="display: inline-block; height: 70px; vertical-align: top; width: 120px;" width="120" height="70"></canvas></span> </div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 text-white">
                  ...
                  <a href="#">View Statement</a> </div>
                <div class="col-md-6 m-t-2 text-right"> <span id="spa-pie"><canvas style="display: inline-block; width: 70px; height: 70px; vertical-align: top;" width="70" height="70"></canvas></span> </div>
              </div>
            </div>
          </div>
        </div>
